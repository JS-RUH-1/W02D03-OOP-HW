...
// const dog = new Animal('Dog', 3, '', "rogh");
// dog.eats();
...
const cat1 = new Cat('Cat', 3, '', "Meow","Bob");
cat1.eats();
...
const animal1 = new Fish("blue whale", 30, "whale.jpg", "sing", "blue");
animal1.eats();
let animal2 = new Cat("persian", 30, "cat.jpg", "meow", "tom");
let animal3 = new Dog("chihuahua", 30, "dog.jpg", "bark", "scott");
let animal4 = new Animal("mouse", 30, "mouse.jpg", "squeek");
