...
dog1.onclick = function(){
   ...
   div.classList.add('h11')
   div.innerText=`DOG:${dog.sound} my name is ${dog.name} and i am ${dog.age} years old , and my oner is ${dog.oner}` 
...
fish1.onclick = function(){
   ...
   div.innerText =` FISH: my name is ${fish.name} and i am ${fish.age} years old , and my color is ${fish.color}`
...
cat1.onclick = function(){
   let div = document.createElement("H1")
   div.innerText=`CAT: ${cat.sound} my name is ${cat.name} and i am ${cat.age} years old , and my oner is ${cat.oner}` 
   document.body.append(div)
